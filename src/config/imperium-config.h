/* src/config/imperium-config.h.  Generated from imperium-config.h.in by configure.  */
/* src/config/imperium-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Imperium Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Imperium Core"
...
#define PACKAGE_BUGREPORT "https://github.com/imperium/imperium/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Imperium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Imperium Core 0.17.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "imperium"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://imperiumcore.org/"
